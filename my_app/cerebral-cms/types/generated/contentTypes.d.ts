...
export interface ApiCaseProgressCaseProgress
  extends Struct.CollectionTypeSchema {
  collectionName: 'case_progresses';
  info: {
    displayName: 'case-progress';
    pluralName: 'case-progresses';
    singularName: 'case-progress';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    case_status: Schema.Attribute.Enumeration<
      ['Not started', 'In progress', 'Completed']
    >;
    case_title: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::case-progress.case-progress'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCaseResultCaseResult extends Struct.CollectionTypeSchema {
  collectionName: 'case_results';
  info: {
    displayName: 'case-result';
    pluralName: 'case-results';
    singularName: 'case-result';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    case_title: Schema.Attribute.String;
    cheerleader: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::case-result.case-result'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    score_out_of: Schema.Attribute.Integer;
    score_total: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPlaySessionPlaySession extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'play-sessions';
    singularName: 'play-session';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::play-session.play-session'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    selected_answer: Schema.Attribute.JSON;
...
export interface ApiPromptImagePromptImage extends Struct.CollectionTypeSchema {
  collectionName: 'prompt_images';
  info: {
    displayName: 'PromptImage';
    pluralName: 'prompt-images';
    singularName: 'prompt-image';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::case-progress.case-progress': ApiCaseProgressCaseProgress;
      'api::case-result.case-result': ApiCaseResultCaseResult;
